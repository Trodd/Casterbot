...
COOLDOWN_CSV_URL: str = _get("COOLDOWN_CSV_URL", "")
TEAM_ROLES_CSV_URL: str = _get("TEAM_ROLES_CSV_URL", "")
PLAYER_HISTORY_CSV_URL: str = _get("PLAYER_HISTORY_CSV_URL", "")
ASSIGNED_MATCHES_CSV_URL: str = _get("ASSIGNED_MATCHES_CSV_URL", "")
